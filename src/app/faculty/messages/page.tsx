      ...
      <main className="flex-1 flex overflow-hidden" style={{ height: "calc(100vh - 73px)" }}>
        <aside className="w-80 border-r border-slate-200 bg-white flex flex-col">
          <div className="p-4 border-b border-slate-100">
            <input placeholder="Search messages..." className="w-full px-3 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 gap-3">
          ...
          <p className="text-sm text-slate-500 text-center max-w-xs">Students and colleagues you connect with will appear here.</p>
        </div>
      </main>
    </>
  );
